Hate to have to redistribute the source of custom crafting, but the source is not publicly available. The only way I can add compatibility is to have the jar in a /libs/ folder.
